...
const slides: Slide[] = [
  ...
  {
    type: "product",
    bg: "from-[#0D1F3C] via-[#1B3A7A] to-[#0d2452]",
    badge: "⚡ Línea Celion",
    badgeClass: "bg-[#3ED9C4]/20 text-[#3ED9C4] border border-[#3ED9C4]/30",
    title: "Mente clara.",
    highlight: "Piel radiante.",
    highlightColor: "text-[#3ED9C4]",
    sub: "NEUROcell · Colágeno Glow · Fórmulas avanzadas Celion",
    textColor: "text-white",
    cta: "Conocer productos",
    btnClass: "bg-[#3ED9C4] text-[#0D1F3C] hover:bg-white font-extrabold",
    waMsg: "Hola Yesit! Me interesan NEUROcell y Colágeno Glow de Celion. ¿Me cuentas más? 🧠🌟",
    productImg: "/images/celion-neurocell-nuevo.png",
    productAlt: "NEUROcell Celion - Rendimiento cognitivo",
    secondImg: "/images/celion-colageno-glow.png",
    secondAlt: "Colágeno Glow Celion",
  },
  /* ── Slide 4: StemRenu + Café Lingzhi ── */
  {
    type: "product",
    bg: "from-[#0D2621] via-[#1a4a35] to-[#0D2621]",
    ...
    textColor: "text-white",
    cta: "Ver más",
    btnClass: "bg-[#FFD100] text-[#0D2621] hover:bg-white font-extrabold",
    waMsg: "Hola Yesit! Me interesan StemRenu y el Café Lingzhi. ¿Me explicas los beneficios? 🌿☕",
    productImg: "/images/stemrenu-poster.png",
    productAlt: "StemRenu - Regenerador Celular",
    secondImg: "/images/cafe-lingzhi.png",
    secondAlt: "Café Lingzhi Black Coffee",
  },
];
